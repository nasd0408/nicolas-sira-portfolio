const translations = {
  en: {
    ...
    "impact.sales": "Power BI dashboards connected operational data to decisions and supported a <strong>14% month-over-month sales increase.</strong>",
    "impact.ownership": "Product ownership",
    "impact.products": "<strong>Two complete multi-tenant products</strong> designed, engineered and deployed from end to end.",
    ...
    "about.degree": "Informatics Engineering · UCLA, 2024",
  ...
  es: {
    ...
    "impact.sales": "Los dashboards de Power BI conectaron datos operativos con decisiones y respaldaron un <strong>aumento intermensual de ventas del 14%.</strong>",
    "impact.ownership": "Responsabilidad de producto",
    "impact.products": "<strong>Dos productos multi-tenant completos</strong>, diseñados, desarrollados y desplegados de punta a punta.",
    ...
    "about.degree": "Ingeniería en Informática · UCLA, 2024",
